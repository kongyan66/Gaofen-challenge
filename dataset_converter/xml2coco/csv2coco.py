...
if __name__ == '__main__':
    csv_file = "/home/z/code/s2anet/data/summit_test/test.csv"  # xml2csv生成的.csv路径
    image_dir = "/home/z/code/s2anet/data/summit_test/images" # 训练集图片路径
    saved_coco_path = "/home/z/code/s2anet/data/summit_test" # 生成coco格式的.json存储路径
    # 整合csv格式标注文件
    ...
    # train_keys, val_keys = train_test_split(total_keys, test_size=0)
